...
public class testRationalNumber extends TestCase {
	...
	public void testRationalDivision() throws DenominatorCeroException {
		setUpEscenario1();
		a.divideRational(b);
	...
	public void testInverse() throws DenominatorCeroException{
		setUpEscenario1();
		a.rationalInverse();
		b.rationalInverse();
		c.rationalInverse();
	...
	public void testMultipliying() throws DenominatorCeroException {
		setUpEscenario1();
	...
	public void testSimplification() throws DenominatorCeroException {
		setUpEscenario1();
		a.simplifyRational();
		b.simplifyRational();
		c.simplifyRational();
	...
	public void testAddingRational() throws DenominatorCeroException {
		setUpEscenario1();
		a.addRational(b);
		b.addRational(c);
